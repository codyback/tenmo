...
public class JdbcTransferDao implements TransferDao{
    ...
    // BASE SQL string to get everything needed for a TRANSFER object
    private final String baseSQL = "SELECT transfer_id, transfer_type_id, transfer_status_id, amount, " +
    ...
    public List<Transfer> listTransfers(int account_id) {
        ...
        String sqlGetTransfers = baseSQL +
