...
public class ConsoleService {
    ...
    public HashMap<Long, Account> printAllUsersWithHashMap(List<Account> accountList, long id) {
        HashMap<Long, Account> accountUsers = new HashMap<>();
        ...
        for (int i = 0; i < accountList.size(); i += 1) {
            ...
            if (id != user.getId()) {
                ...
                accountUsers.put(user.getId(), account);
            }
        }
        System.out.println("0: Exit");
        System.out.println("");
    ...
    public void printApprovedTransferConfirmation (Transfer transfer) {
        if (transfer != null) {
            ...
            System.out.println("Your new balance is: " + transfer.getAccountFrom().getBalance());
        } else {
